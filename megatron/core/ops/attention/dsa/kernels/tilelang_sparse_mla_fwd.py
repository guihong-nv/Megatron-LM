...
def _get_sparse_mla_fwd_kernel(
    ...
    return _get_cached_kernel(
        _tilelang_sparse_mla_fwd_kernel_cache,
        _tilelang_sparse_mla_fwd_cache_lock,
        key,
        lambda: sparse_mla_fwd(
            heads,
            dim,
            tail_dim,
            topk,
...
def sparse_mla_fwd(  # pragma: no cover
...
def sparse_mla_fwd_interface(
    ...
    assert q.ndim == 4 and kv.ndim == 4 and indices.ndim == 4
